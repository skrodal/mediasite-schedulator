...
(function(za, O, l) {
    var N = function(h) {
        ...
        function Aa(a, b) {
            var c = p.defaults.column, d = a.aoColumns.length, c = h.extend({}, p.models.oColumn, c, {nTh: b ? b : O.createElement("th"), sTitle: c.sTitle ? c.sTitle : b ? b.innerHTML : "", aDataSort: c.aDataSort ? c.aDataSort :
                                                                                                                                                                                                         [
                                                                                                                                                                                                             d
        ...
        function fa(a, b, c) {
            ...
            c !== l && null !== c && (eb(c), G(p.defaults.column, c), c.mDataProp !== l && !c.mData && (c.mData = c.mDataProp), c.sType && (b._sManualType = c.sType), c.className && !c.sClass && (c.sClass = c.className), h.extend(b, c), D(b, c, "sWidth", "sWidthOrig"), "number" === typeof c.iDataSort && (b.aDataSort =
                                                                                                                                                                                                                                                                                                                  [
                                                                                                                                                                                                                                                                                                                      c.iDataSort
                                                                                                                                                                                                                                                                                                                  ]), D(b, c, "aDataSort"));
            var g = b.mData, j = U(g), i = b.mRender ? U(b.mRender) : null, c = function(a) {return"string" === typeof a && -1 !== a.indexOf("@")};
                    ...
                    for(g = n.length; f < g; f++) {
                        if("number" === typeof n[f] && 0 <= n[f]) {
                            ...
                            for(i = m.length; j < i; j++) {
                                ("_all" == n[f] || h(m[j].nTh).hasClass(n[f])) && d(j, o)
                            }
                        }
                    }
                }
        ...
        function ia(a, b) {
            var c = [], d = [
            ], e = b.firstChild, f, g, j, i = 0, o, m = a.aoColumns, n = function(a, b, c) {"string" === typeof a && (b = a.indexOf("@"), -1 !== b && (a = a.substring(b + 1), j["@" + a] = c.getAttribute(a)))}, k = function(a) {
                g = m[i];
        ...
        function ib(a) {
            ...
            for(c = m.length; b < c; b++) {
                f = m[b], d = h(f.nTh).addClass(f.sClass), i && d.appendTo(e), a.oFeatures.bSort && (d.addClass(f.sSortingClass), !1 !== f.bSortable && (d.attr("tabindex", a.iTabIndex).attr("aria-controls", a.sTableId), Ka(a, f.nTh, b))), f.sTitle != d.html() && d.html(f.sTitle), La(a, "header")(a, d, f, o);
            }
            i && aa(a.aoHeader, g);
            ...
            for(i = c.length; f < i; f++) {
                ...
                for(e = d.firstChild; e;) {
                    if("TD" == e.nodeName.toUpperCase() || "TH" == e.nodeName.toUpperCase()) {
                        ...
                        for(j = 0; j < m; j++) {
                            for(g = 0; g < n; g++) {
                                a[f + g][o + j] = {cell: e, unique: k}, a[f + g].nTr = d
                            }
                        }
                    }
                    e = e.nextSibling
        ...
        function sb(a) {
            ...
            for(g = 0; g < c; g++) {
                o = b[g], m = f[g], i = "function" == typeof o.mData ? "function" : o.mData, l.columns.push({data: i, name: o.sName, searchable: o.bSearchable, orderable: o.bSortable, search: {value: m.sSearch, regex: m.bRegex}}), k("mDataProp_" + g, i), d.bFilter && (k("sSearch_" + g, m.sSearch), k("bRegex_" + g, m.bRegex), k("bSearchable_" + g, o.bSearchable)), d.bSort && k("bSortable_" + g, o.bSortable);
            }
            ...
            for(f = a.aoData.length; d < f; d++) {
                if(h = a.aoData[d], !h._aFilterData) {
                    ...
                    for(g = b.length; e < g; e++) {
                        if(c = b[e], c.bSearchable ? (i = A(a, d, e, "filter"), i = m[c.sType] ? m[c.sType](i) : null !== i ? i : "") : i = "", i) {
                            i.indexOf && -1 !== i.indexOf("&") && (qa.innerHTML = i, i = Wb ? qa.textContent : qa.innerText), i.replace && (i = i.replace(/[\r\n]/g, "")), j.push(i);
                        }
                    }
                    h._aFilterData = j;
        ...
        function pb(a) {
            ...
            m && c.append(h("<div/>", {"class": f.sScrollFoot}).css({overflow: "hidden", border: 0, width: d ? !d ? null : s(d) : "100%"}).append(h("<div/>", {"class": f.sScrollFootInner}).append(o.removeAttr("id").css("margin-left", 0).append(b.children("tfoot")))).append("bottom" === j ? g : null));
        ...
        function W(a) {
            ...
            g = q.outerWidth();
            if("" === c) {
                if(M.width = "100%", v && (q.find("tbody").height() > i.offsetHeight || "scroll" == n.css("overflow-y"))) {
                    M.width = s(q.outerWidth() - f)
                }
            } else {
                "" !== d ? M.width = s(d) : g == n.width() && n.height() < q.height() ? (M.width = s(g - f), q.outerWidth() > g - f && (M.width = s(g))) : M.width = s(g);
            }
            g = q.outerWidth();
            F(E, x);
            F(function(a) {
            ...
            if(q.outerWidth() < g) {
                ...
                if(v && (i.scrollHeight > i.offsetHeight || "scroll" == n.css("overflow-y"))) {
                    M.width = s(t - f);
                }
        ...
        function Ca(a) {
            ...
            for(k = 0; k < d.length; k++) {
                l = c[d[k]], null !== l.sWidth && (l.sWidth = Cb(l.sWidthOrig, m), n = !0);
            }
            if(!n && !f && !e && j == Z(a) && j == i.length) {
                ...
                if(a.aoData.length) {
                    for(k = 0; k < d.length; k++) {
                        n = d[k], l = c[n], h(Db(a, n)).clone(!1).append(l.sContentPadding).appendTo(p);
                    }
                }
                j.appendTo(m);
        ...
        function R(a) {
            ...
            for(a = 0; a < o.length; a++) {
                ...
                for(c = f.length; b < c; b++) {
                    g = f[b], j = e[g].sType || "string", d.push({src: i, col: g, dir: o[a][1], index: o[a][2], type: j, formatter: p.ext.type.order[j + "-pre"]})
                }
            }
            return d
        }
        ...
        function ta(a) {
            if(a.oFeatures.bStateSave && !a.bDestroying) {
                var b = {time: +new Date, start: a._iDisplayStart, length: a._iDisplayLength, order: h.extend(!0, [
                ], a.aaSorting), search: yb(a.oPreviousSearch), columns: h.map(a.aoColumns, function(b, d) {return{visible: b.bVisible, search: yb(a.aoPreSearchCols[d])}})};
        ...
        function cb(a) {
            h.each({num : function(b) {
                return va(b, a)
            }, "num-fmt": function(b) {return va(b, a, Va)}, "html-num": function(b) {return va(b, a, wa)}, "html-num-fmt": function(b) {return va(b, a, wa, Va)}}, function(b, c) {t.type.order[b + a + "-pre"] = c})
        }
        ...
        var p, t, q, r, v, Wa = {}, Nb = /[\r\n]/g, wa = /<.*?>/g, Yb = /^[\w\+\-]/, Zb = /[\w\+\-]$/, Vb = RegExp("(\\/|\\.|\\*|\\+|\\?|\\||\\(|\\)|\\[|\\]|\\{|\\}|\\\\|\\$|\\^|\\-)", "g"), Va = /[',$\u00a3\u20ac\u00a5%\u2009\u202F]/g, H = function(a) {return!a || !0 === a || "-" === a ? !0 : !1}, Ob = function(a) {
                var b = parseInt(a, 10);
            ...
            }, Qb = function(a, b, c) {return H(a) ? !0 : !(H(a) || "string" === typeof a) ? null : Xa(a.replace(wa, ""), b, c) ? !0 : null}, C = function(a, b, c) {
            ...
            for(var e = b; e < d; e++) {
                ...
                return b
            }, w = function(a, b, c) {a[b] !== l && (a[c] = a[b])}, $ = /\[.*?\]$/, Q = /\(\)$/, qa = h("<div>")[0], Wb = qa.textContent !== l, Xb = /<.*?>/g;
        p = function(a) {
            ...
            this.each(function() {
                var e = {}, g = 1 < d ? Kb(e, a, !0) : a, j = 0, i, o = this.getAttribute("id"), e = !1, m = p.defaults;
                if("table" != this.nodeName.toLowerCase()) {
                    ...
                    if(null === o || "" === o) {
                        this.id = o = "DataTables_Table_" + p.ext._unique++;
                    }
                    ...
                    D(k, g, ["asStripeClasses", "ajax", "fnServerData", "fnFormatNumber", "sServerMethod", "aaSorting",
                    ...
                    if(g.aaSorting === l) {
                        ...
                        j = 0;
                        for(i = n.length; j < i; j++) {
                            n[j][1] = k.aoColumns[j].asSorting[0]
                        }
                    }
                    sa(k);
        ...
        q.prototype = {concat: y.concat, context: [], each: function(a) {
            ...
            var d = [], e, f, g, h, i, o = this.context, m, n, k = this.selector;
            "string" === typeof a && (c = b, b = a, a = !1);
            f = 0;
            for(g = o.length; f < g; f++) {
                if("table" === b) {
                    e = c(o[f], f), e !== l && d.push(e);
                } else if("columns" === b || "rows" === b) {
                    e = c(o[f], this[f], f), e !== l && d.push(e);
                } else if("column" === b || "column-rows" === b || "row" === b || "cell" === b) {
                    n = this[f];
                    "column-rows" === b && (m = Ya(o[f], k.opts));
                    h = 0;
                    for(i = n.length; h < i; h++) {
                        e = n[h], e = "cell" === b ? c(o[f], e.row, e.column, f, h) : c(o[f], e, f, h, m), e !== l && d.push(e)
                    }
                }
            }
            return d.length ? (a = new q(o, a ? d.concat.apply([
            ...
            return new q(this.context, b)
        }, pluck             : function(a) {return this.map(function(b) {return b[a]})}, pop: y.pop, push: y.push, reduce: y.reduce || function(a, b) {return gb(this, a, b, 0, this.length, 1)}, reduceRight: y.reduceRight || function(a, b) {
        ...
        v("tables().containers()", "table().container()", function() {return this.iterator("table", function(a) {return a.nTableWrapper})});
        ...
        var Za = function(a, b) {
            ...
            for(var b = 0, c = a.length; b < c; b++) {
                if(0 < a[b].length) {
                    return a[0] = a[b], a.length = 1, a.context = [a.context[b]
                    ], a;
                }
            }
            a.length = 0;
        ...
        r("rows()", function(a, b) {
            ...
            var b = $a(b), c = this.iterator("table", function(c) {
                ...
                return Za(a, function(a) {
                    ...
                    for(var b = [], i = 0, o = j.length; i < o; i++) {
                        b.push(c.aoData[j[i]].nTr);
                    }
                    return a.nodeName && h.inArray(a, b) !== -1 ?
                           [a._DT_RowIndex] : h(b).filter(a).map(function() {return this._DT_RowIndex}).toArray()
                })
            });
            c.selector.rows = a;
            c.selector.opts = b;
        ...
        r("row.add()", function(a) {
            ...
            var b = this.iterator("table", function(b) {return a.nodeName && "TR" === a.nodeName.toUpperCase() ? ha(b, a)[0] : I(b, a)});
            return this.row(b[0])
        });
        var bb = function(a) {
            var b = a.context;
                          ...
                          if(d.bVisible !== a) {
                              if(a) {
                                  ...
                                  for(j = f.length; g < j; g++) {
                                      i = f[g].nTr, e = f[g].anCells, i && i.insertBefore(e[c], e[o] || null)
                                  }
                              } else {
        ...
        r("cells()", function(a, b, c) {
            ...
            if(null === b || b === l) {
                return this.iterator("table", function(b) {
                    var d = a, e = $a(c), f = b.aoData, g = Ya(b, e), e = xa(f, g, "anCells"), i = h([].concat.apply([
                                                                                                                     ], e)), j, m = b.aoColumns.length, o, p, r, q;
        ...
        r("order.listener()", function(a, b, c) {return this.iterator("table", function(d) {Ka(d, a, b, c)})});
        ...
        p.tables = p.fnTables = function(a) {return jQuery.map(p.settings, function(b) {
        ...
        r("destroy()", function(a) {
            a = a || !1;
            return this.iterator("table", function(b) {
                var c = b.nTableWrapper.parentNode, d = b.oClasses, e = b.nTable, f = b.nTBody, g = b.nTHead, j = b.nTFoot, i = h(e), f = h(f), l = h(b.nTableWrapper), m = h.map(b.aoData, function(a) {return a.nTr}), n;
                b.bDestroying = !0;
                ...
                (n = b.asDestroyStripes.length) && f.children().each(function(a) {h(this).addClass(b.asDestroyStripes[a % n])});
        ...
        p.models.oRow = {nTr: null, anCells: null, _aData: [
        ...
        p.defaults = {aaData: null, aaSorting: [
            [0, "asc"]
        ], aaSortingFixed: [], ajax: null, aLengthMenu: [10, 25, 50, 100
        ], aoColumns: null, aoColumnDefs: null, aoSearchCols: [
        ], asStripeClasses: null, bAutoWidth: !0, bDeferRender: !1, bDestroy: !1, bFilter: !0, bInfo: !0, bJQueryUI: !1, bLengthChange: !0, bPaginate: !0, bProcessing: !1, bRetrieve: !1, bScrollCollapse: !1, bServerSide: !1, bSort: !0, bSortMulti: !0,
            bSortCellsTop: !1, bSortClasses: !0, bStateSave: !1, fnCreatedRow: null, fnDrawCallback: null, fnFooterCallback: null, fnFormatNumber: function(a) {return a.toString().replace(/\B(?=(\d{3})+(?!\d))/g, this.oLanguage.sThousands)}, fnHeaderCallback: null, fnInfoCallback: null, fnInitComplete: null, fnPreDrawCallback: null, fnRowCallback: null, fnServerData: null, fnServerParams: null, fnStateLoadCallback: function(a) {
                try {
        ...
        T(p.defaults);
        p.defaults.column = {aDataSort: null, iDataSort: -1, asSorting: ["asc", "desc"
        ], bSearchable                : !0, bSortable: !0, bVisible: !0, fnCreatedCell: null, mData: null, mRender: null, sCellType: "td", sClass: "", sContentPadding: "", sDefaultContent: null, sName: "", sSortDataType: "std", sTitle: null, sType: null, sWidth: null};
        T(p.defaults.column);
        p.models.oSettings = {oFeatures: {bAutoWidth: null,
            bDeferRender                            : null, bFilter: null, bInfo: null, bLengthChange: null, bPaginate: null, bProcessing: null, bServerSide: null, bSort: null, bSortMulti: null, bSortClasses: null, bStateSave: null}, oScroll: {bCollapse: null, iBarWidth: 0, sX: null, sXInner: null, sY: null}, oLanguage: {fnInfoCallback: null}, oBrowser: {bScrollOversize: !1, bScrollbarLeft: !1}, ajax: null, aanFeatures:
            [], aoData: [], aiDisplay: [], aiDisplayMaster: [], aoColumns: [], aoHeader: [], aoFooter: [
            ...
            ], aoStateSaveParams: [], aoStateLoadParams: [], aoStateLoaded: [
            ], sTableId: "", nTable: null, nTHead: null, nTFoot: null, nTBody: null, nTableWrapper: null, bDeferLoading: !1, bInitialised: !1, aoOpenRows:
                [], sDom: null, sPaginationType: "two_button", iStateDuration: 0, aoStateSave: [], aoStateLoad: [
            ], oSavedState: null, oLoadedState: null, sAjaxSource: null, sAjaxDataProp: null,
            bAjaxDataGet: !0, jqXHR: null, json: l, oAjaxData: l, fnServerData: null, aoServerParams: [
            ], sServerMethod: null, fnFormatNumber: null, aLengthMenu: null, iDraw: 0, bDrawing: !1, iDrawError: -1, _iDisplayLength: 10, _iDisplayStart: 0, _iRecordsTotal: 0, _iRecordsDisplay: 0, bJUI: null, oClasses: {}, bFiltered: !1, bSorted: !1, bSortCellsTop: null, oInit: null, aoDestroyCallback:
                [
                ], fnRecordsTotal: function() {return"ssp" == z(this) ? 1 * this._iRecordsTotal : this.aiDisplayMaster.length}, fnRecordsDisplay: function() {
        ...
        p.ext = t = {classes: {}, errMode: "alert", feature: [], search: [
        ], internal: {}, legacy: {ajax: null}, pager: {}, renderer: {pageButton: {}, header: {}}, order: {}, type: {detect:
            [],
        ...
        var Lb = p.ext.pager;
        h.extend(Lb, {simple: function() {return["previous", "next"]}, full: function() {
            return["first", "previous", "next", "last"]
        }, simple_numbers   : function(a, b) {return["previous", Ua(a, b), "next"]}, full_numbers: function(a, b) {
        ...
        h.extend(t.type.order, {"date-pre": function(a) {return Date.parse(a) || 0}, "html-pre": function(a) {return H(a) ? "" : a.replace ? a.replace(/<.*?>/g, "").toLowerCase() : a + ""}, "string-pre": function(a) {return H(a) ? "" : "string" === typeof a ? a.toLowerCase() : !a.toString ? "" : a.toString()}, "string-asc": function(a, b) {return a < b ? -1 : a > b ? 1 : 0}, "string-desc": function(a, b) {return a < b ? 1 : a > b ? -1 : 0}});
        cb("");
    ...
    ], N) : "object" === typeof exports ? N(require("jquery")) : jQuery && !jQuery.fn.dataTable && N(jQuery)
})(window, document);
