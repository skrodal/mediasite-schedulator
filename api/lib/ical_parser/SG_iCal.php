...
/**
 * A simple iCal ical_parser. Should take care of most stuff for ya
...
class SG_iCal {
	...
	//
	private $parseStatus = false; // Did the .ics parse ok?
	...
	/**
	 * Did the .ics feed exist?
	 * @author SimonS
	 * @param $bool
	 */
	public function setParseStatus($bool = false) {
		$this->parseStatus = $bool;
	}
